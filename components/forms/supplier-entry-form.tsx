  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5 p-1">
      ...
      <div className="grid gap-4 grid-cols-1 sm:grid-cols-2">
        ...
        <div>
          <Label htmlFor="lpo" className="text-sm sm:text-base font-semibold text-red-700">
      ...
      <div>
        <Label htmlFor="materials" className="text-sm sm:text-base font-semibold text-red-700">
          Materials
        </Label>
        <Textarea
          id="materials"
